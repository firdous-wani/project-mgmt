  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Streamline your project management with our modern, intuitive platform" />
      ...
      <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
            ...
            <div className="mx-auto max-w-2xl flex-shrink-0 lg:mx-0 lg:max-w-xl lg:pt-8">
              <div className="mt-24 sm:mt-32 lg:mt-16">
                ...
                <p className="mt-4 text-lg leading-8 text-gray-600">
                  Streamline your project management with our intuitive platform. Collaborate with your team, track tasks, and achieve your goals efficiently.
                </p>
              </div>
        ...
        <div id="features" className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our platform provides all the features you need to manage projects effectively, from task tracking to team collaboration.
            </p>
          </div>
            ...
            <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
              <div className="flex flex-col">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">Create, assign, and track tasks with ease. Set priorities, due dates, and track progress in real-time.</p>
                </dd>
              </div>
              <div className="flex flex-col">
                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">Work together seamlessly with your team. Share updates, assign tasks, and communicate effectively.</p>
                </dd>
              </div>
              <div className="flex flex-col">
                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900">
                ...
                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600">
                  <p className="flex-auto">Get insights into your project's progress with detailed analytics and reporting tools.</p>
                </dd>
              </div>
            </dl>
          </div>
